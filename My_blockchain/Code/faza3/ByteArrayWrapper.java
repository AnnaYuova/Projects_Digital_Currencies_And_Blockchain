package SkuskaBlockchain;

import java.util.Arrays;

public class UTXO implements Comparable<UTXO> {

    /** Hash transakcie, z ktorej toto UTXO pochadza */
    private byte[] txHash;

    /** Index prisluchajuceho vystupu v transakcii */
    private int index;

    /**
     * Vytvori nove UTXO zodpovedajuce vystupu s indexom <index> v transakcii,
    ...
    /** @return transakcny hash tohto UTXO */
